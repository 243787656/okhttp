...
final class Relay {
   ...
   * resources are released and all following calls to {@link #newSource} return null.
   */
  ...
  class RelaySource implements Source {
     ...
     * upstream and copy them to both the file and to the buffer. Finally we release the release
     * the upstream reader lock and return the new bytes.
     *
     * <h3>The file</h3>
